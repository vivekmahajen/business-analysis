  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-950 via-blue-900 to-blue-800 text-white">
      ...
      <div className="max-w-5xl mx-auto px-8 py-20 text-center">
        ...
        <h2 className="font-syne font-bold text-3xl text-white mb-3">Simple, transparent pricing</h2>
        <p className="text-blue-300 text-sm mb-8">Free to start · Paid plans from $29/mo · No long-term contract</p>
        <button
          onClick={onPricing}
          className="inline-flex items-center gap-2 bg-white/10 hover:bg-white/20 border border-white/20 text-white font-semibold px-8 py-3.5 rounded-xl transition-colors text-sm"
        >
