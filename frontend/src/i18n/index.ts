...
const BASE_EN: T = {
  ...
  getReport: 'Get Started Free',
  viewSavedReports: 'View Saved Reports',
  oneTimePayment: 'Free to start · Paid plans from $29/mo · No long-term contract',
  ...
  analyzeWebsite: 'Analyze Your Business',
  // Features
...
const OVERRIDES: Record<string, Partial<T>> = {
  es: {
    ...
    getReport: 'Comenzar Gratis',
    viewSavedReports: 'Ver Informes Guardados',
    oneTimePayment: 'Gratis para empezar · Planes desde $29/mes · Sin compromiso',
    ...
    analyzeWebsite: 'Analizar un Sitio Web',
  ...
  fr: {
    ...
    getReport: 'Commencer Gratuitement',
    viewSavedReports: 'Voir les Rapports Enregistrés',
    oneTimePayment: 'Gratuit pour commencer · Plans dès 29 $/mois · Sans engagement',
    ...
    analyzeWebsite: 'Analyser un Site Web',
  ...
  de: {
    ...
    getReport: 'Kostenlos starten',
    viewSavedReports: 'Gespeicherte Berichte anzeigen',
    oneTimePayment: 'Kostenlos starten · Pläne ab 29 $/Monat · Keine Laufzeit',
  ...
  pt: {
    ...
    analyzeWebsite: 'Analisar um Site',
  ...
  it: {
    ...
    analyzeWebsite: 'Analizza un Sito',
  ...
  ru: {
    ...
    analyzeWebsite: 'Анализировать сайт',
  ...
  hi: {
    ...
    analyzeWebsite: 'वेबसाइट विश्लेषण',
  ...
  tr: {
    ...
    analyzeWebsite: 'Web Sitesi Analiz Et',
  ...
  id: {
    ...
    analyzeWebsite: 'Analisis Situs Web',
