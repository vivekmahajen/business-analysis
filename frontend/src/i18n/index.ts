...
const BASE_EN: T = {
  ...
  oneTimePayment: '$99/month until July 1st 2026 · 50 reports/month · $299/mo regular · 50+ reports $399/mo · Cancel anytime',
  ...
  analyzeWebsite: 'Analyze Your Business — $99/mo',
  // Features
...
const OVERRIDES: Record<string, Partial<T>> = {
  es: {
    ...
    getReport: 'Comenzar — $99/mes',
    viewSavedReports: 'Ver Informes Guardados',
    oneTimePayment: 'Precio promocional · 50 informes/mes · $299/mes precio normal · Cancela cuando quieras',
    ...
    analyzeWebsite: 'Analizar un Sitio Web — $99/mes',
  ...
  fr: {
    ...
    getReport: 'Commencer — 99 $/mois',
    viewSavedReports: 'Voir les Rapports Enregistrés',
    oneTimePayment: 'Prix promotionnel · 50 rapports/mois · 299 $/mois tarif normal · Annulez à tout moment',
    ...
    analyzeWebsite: 'Analyser un Site Web — 99 $/mois',
  ...
  de: {
    ...
    getReport: 'Jetzt starten — 99 $/Monat',
    viewSavedReports: 'Gespeicherte Berichte anzeigen',
    oneTimePayment: 'Aktionspreis · 50 Berichte/Monat · 299 $/Monat Normalpreis · Jederzeit kündbar',
    ...
    analyzeWebsite: 'Website analysieren — 99 $/Monat',
  ...
  pt: {
    ...
    analyzeWebsite: 'Analisar um Site — $99/mês',
  ...
  it: {
    ...
    analyzeWebsite: 'Analizza un Sito — $99/mese',
  ...
  ru: {
    ...
    analyzeWebsite: 'Анализировать сайт — $99/мес',
  ...
  ar: {
    ...
    analyzeWebsite: 'تحليل موقع ويب — $99/شهر',
  ...
  hi: {
    ...
    analyzeWebsite: 'वेबसाइट विश्लेषण — $99/माह',
  ...
  tr: {
    ...
    analyzeWebsite: 'Web Sitesi Analiz Et — $99/ay',
  ...
  id: {
    ...
    analyzeWebsite: 'Analisis Situs Web — $99/bulan',
